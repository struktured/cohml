module type S =
sig
    include Coh_object.S with module Self = Coh_observable_map.Map_listener.Self
    module Map_event : Map_event.S
...
module Make(Map_event:Map_event.S) : S with module Map_event = Map_event =
  struct
  open Ctypes
  open Foreign
